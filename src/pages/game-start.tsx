...
import s from "../entity/404/components/content/style.module.scss";
...
const GameStart = () => {
    const descItem: string[] = ['Искусственный интеллект', 'поможет найти питомца,', 'подходящего именно вам или стать', 'ещё ближе с вашим любимцем']
    return (
        <GameWrapper>
            <Header/>
            <BodyInfoStart>
