...
const GameResultAnalysis = () => {
    const descItem = ['Искусственный интеллект проанализировал', 'ВАШИ ОТВЕТЫ и подобрал БЛИЗКИХ ВАМ', 'по характеру питомцев из приюта']
    const descMobile = ['Искусственный интеллект', 'проанализировал ВАШИ ОТВЕТЫ', 'и подобрал БЛИЗКИХ ВАМ', 'по характеру питомцев из приюта']
    ...
    return (<GameAnalysisWrapper>
        <Header/>
        <BodyAdvice>
            <div className={"wrapper-result-analysis"}>
                {width < 660 && <DynamicEcho type='heart'>
